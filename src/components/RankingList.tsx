  ...
  return (
    ...
    >
      <li className="border-4 border-orange-200 col-span-1 flex flex-col divide-y divide-gray-200 rounded-lg bg-white text-center shadow sm:min-h-[400px]">
        <div className="flex flex-1 flex-col  sm:p-8">
          <div className="relative">
            <div className="absolute top-1 left-1 p-1 bg-red-400 border-4 border-white rounded-full text-white text-xl font-bold items-center text-center flex justify-center w-12 h-12 whitespace-nowrap">
              1
            </div>
            <a href="/">
              {" "}
      ...
      <li className="border-4 border-orange-200 col-span-1 flex flex-col divide-y divide-gray-200 rounded-lg bg-white text-center shadow sm:min-h-[400px]">
        <div className="flex flex-1 flex-col  sm:p-8">
          <div className="relative">
            <div className="absolute top-1 left-1 p-1 bg-blue-400 border-4 border-white rounded-full text-white text-xl font-bold items-center text-center flex justify-center w-12 h-12 whitespace-nowrap">
              2
            </div>
            <a href="/">
              {" "}
      ...
      <li className="border-4 border-orange-200 col-span-1 flex flex-col divide-y divide-gray-200 rounded-lg bg-white text-center shadow sm:min-h-[400px]">
        <div className="flex flex-1 flex-col  sm:p-8">
          <div className="relative">
            <div className="absolute top-1 left-1 p-1 bg-green-400 border-4 border-white rounded-full text-white text-xl font-bold items-center text-center flex justify-center w-12 h-12 whitespace-nowrap">
              3
            </div>
            <a href="/">
              {" "}
      ...
      <li className="border-4 border-orange-200 col-span-1 flex flex-col divide-y divide-gray-200 rounded-lg bg-white text-center shadow sm:min-h-[400px]">
        <div className="flex flex-1 flex-col  sm:p-8">
          <div className="relative">
            <div className="absolute top-1 left-1 p-1 bg-yellow-300 border-4 border-white rounded-full text-white text-xl font-bold items-center text-center flex justify-center w-12 h-12 whitespace-nowrap">
              4
            </div>
            <a href="/">
              {" "}
      ...
      <li className="border-4 border-orange-200 col-span-1 flex flex-col divide-y divide-gray-200 rounded-lg bg-white text-center shadow sm:min-h-[400px]">
        <div className="flex flex-1 flex-col  sm:p-8">
          <div className="relative">
            <div className="absolute top-1 left-1 p-1 bg-gray-300 border-4 border-white rounded-full text-white text-xl font-bold items-center text-center flex justify-center w-12 h-12 whitespace-nowrap">
              5
            </div>
            <a href="/">
              {" "}
